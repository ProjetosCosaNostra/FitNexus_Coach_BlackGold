    ...
    return Row(
      children: <Widget>[
        ...
        if (showButtons) ...<Widget>[
          ...
          const _SmallButton(text: 'Entrar', filled: false, onTap: _emptyAction),
          const SizedBox(width: 10),
          const _SmallButton(text: 'Criar conta', filled: true, onTap: _emptyAction),
        ],
      ],
    );
  }
