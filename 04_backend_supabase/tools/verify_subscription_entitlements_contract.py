...
def main() -> int:
    ...
    checks = [
        (
            migrations,
            "subscription_plans",
            "BGF-SUBSCRIPTION-PLAN-AUTHORITY-047",
            "provider-neutral plan catalog disappeared",
        ),
        (
            migrations,
            "organization_subscriptions",
            "BGF-SUBSCRIPTION-STATE-AUTHORITY-048",
            "organization subscription authority disappeared",
        ),
        (
            migrations,
            "subscription_authority_events",
            "BGF-SUBSCRIPTION-EVENT-EVIDENCE-049",
            "immutable subscription authority event ledger disappeared",
        ),
        (
            migrations,
            "'trial','BlackGold Trial','active',10,1,14",
            "BGF-SUBSCRIPTION-TRIAL-BOOTSTRAP-050",
            "14-day trial bootstrap contract drifted",
        ),
        (
            migrations,
            "aa_on_organization_subscription_created",
            "BGF-SUBSCRIPTION-TRIAL-BOOTSTRAP-050",
            "automatic trial initialization trigger disappeared",
        ),
        (
            migrations,
            "students_subscription_limit_gate",
            "BGF-SUBSCRIPTION-STUDENT-LIMIT-051",
            "server-side student capacity gate disappeared",
        ),
        (
            migrations,
            "organization_members_subscription_limit_gate",
            "BGF-SUBSCRIPTION-MEMBER-LIMIT-052",
            "server-side team capacity gate disappeared",
        ),
        (
            migrations,
            "training_plans_subscription_write_gate",
            "BGF-SUBSCRIPTION-WRITE-GATE-053",
            "training-plan commercial write gate disappeared",
        ),
        (
            migrations,
            "decision_intelligence_subscription_gate",
            "BGF-SUBSCRIPTION-FEATURE-GATE-054",
            "Decision Intelligence entitlement gate disappeared",
        ),
        (
            migrations,
            "get_subscription_entitlement_snapshot",
            "BGF-SUBSCRIPTION-SNAPSHOT-055",
            "subscription/usage snapshot RPC disappeared",
        ),
        (
            migrations,
            "'state', 'UNFROZEN'",
            "BGF-SUBSCRIPTION-PRICE-AUTHORITY-056",
            "pricing must stay explicitly unfrozen until a provider/pricing decision is promoted",
        ),
        (
            migrations,
            "'provider_neutral_core', true",
            "BGF-SUBSCRIPTION-PROVIDER-COUPLING-057",
            "provider-neutral entitlement guardrail disappeared",
        ),
        (
            migrations,
            "apply_subscription_authority_event",
            "BGF-SUBSCRIPTION-PROVIDER-EVENT-058",
            "controlled provider authority event command disappeared",
        ),
        (
            migrations,
            "idempotent_replay",
            "BGF-SUBSCRIPTION-EVENT-IDEMPOTENCY-059",
            "provider event replay protection disappeared",
        ),
        (
            repository,
            "get_subscription_entitlement_snapshot",
            "BGF-SUBSCRIPTION-FLUTTER-BINDING-060",
            "Flutter subscription snapshot RPC binding disappeared",
        ),
        (
            page,
            "Plano & assinatura",
            "BGF-SUBSCRIPTION-WORKSPACE-061",
            "professor subscription workspace disappeared",
        ),
        (
            shell,
            "ProfessorSubscriptionPage()",
            "BGF-SUBSCRIPTION-ENTRYPOINT-062",
            "subscription workspace entrypoint disappeared",
        ),
    ]
