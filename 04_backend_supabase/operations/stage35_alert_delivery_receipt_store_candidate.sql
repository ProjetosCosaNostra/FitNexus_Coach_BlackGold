-- Stage 35 repository-only candidate: external alert delivery receipt store and service bridge.
--
-- THIS FILE IS NOT A MIGRATION AND MUST NOT BE EXECUTED FROM operations/.
-- Promotion to migrations/ requires a separately reviewed exact-source promotion after CI.
-- No Stage33 privilege, transport, proof or cleanup boundary is changed here.
--
-- Failure classes:
