-- Stage 35 controlled external-delivery proof cleanup migration promotion.
--
-- REPOSITORY-ONLY MIGRATION. Remote application is forbidden until this exact
-- promotion passes CI and is merged to main. The executable body below is
-- byte-identical to operations/stage35_alert_delivery_controlled_proof_cleanup_candidate.sql.
--
-- Immutable successful proof sealed before this promotion:
--   PR #117 / run 32650555123 / job 97221340290 / head 731b0626a5b87d03fc598d5632e60df73b2a22c7
--
-- Failure classes:
