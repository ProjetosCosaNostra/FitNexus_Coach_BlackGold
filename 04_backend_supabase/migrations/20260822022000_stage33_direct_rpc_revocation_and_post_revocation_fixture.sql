-- Stage 33: promote the already CI-reviewed revocation+fixture candidate into an apply-once migration.
--
-- Executable SQL from `do $$` onward is byte-identical to the preparation candidate blob
-- 08fbbf71ec51583c8e46792ed88b28825394e9f1. This migration remains repo-only until a
-- separate one-shot post-revocation proof workflow is sealed and merged, followed by a
-- fresh quiet/security-advisor pre-apply gate.
--
-- Failure classes:
