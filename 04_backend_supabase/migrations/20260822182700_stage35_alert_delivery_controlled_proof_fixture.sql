-- Stage 35 controlled external-delivery proof fixture.
--
-- Repository promotion only. Remote application remains forbidden until runtime-secret
-- readiness is proven outside repository source and a fresh pre-apply gate passes.
-- Executable body is byte-identical to the reviewed operations candidate.
--
-- Failure classes:
