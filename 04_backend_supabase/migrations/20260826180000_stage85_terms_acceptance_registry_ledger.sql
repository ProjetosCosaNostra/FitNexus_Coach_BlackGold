-- FitNexus Coach BlackGold — Stage86 repository-only migration promotion.
--
-- Executable SQL from the standalone `do $$` line onward is byte-identical to the
-- Stage85 reviewed operations candidate blob `990ee4b1a5d36324d8eb395c7096b3f6af23cdfa`.
-- This migration is repository-only in Stage86. It MUST NOT be applied remotely until
-- a later promotion/apply lifecycle performs a fresh remote precondition check against
-- the exact merged migration and explicitly authorizes one canonical apply.
--
-- No Terms artifact is registered by this migration. No acceptance row is seeded.
-- Draft Terms remain unapproved/unpublished and `TERMS_ACCEPTANCE_VERSIONING` remains OPEN.
--
-- Failure classes:
--   BGF-STAGE86-CANDIDATE-BYTE-DRIFT-852
--   BGF-STAGE86-MIGRATION-LEDGER-UNDECLARED-REPO-ONLY-853
--   BGF-STAGE86-SQL-MARKER-COMMENT-COLLISION-854
--   BGF-STAGE86-PREMATURE-REMOTE-APPLY-855
--   BGF-STAGE86-PREMATURE-TERMS-DATA-SEED-856
--   BGF-STAGE86-PREMATURE-TERMS-GATE-PROMOTION-857
--   BGF-STAGE86-TERMS-ACCEPTANCE-MIGRATION-PROMOTION-GUARD-858
