...
class LandingPage extends StatelessWidget {
  ...
  static const Color canvas = Color(0xFF070707);
    ...
    return DecoratedBox(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: <Color>[Color(0xFF0B0B0B), LandingPage.canvas],
        ),
      ),
      child: _Shell(
        child: Padding(
        ...
        const Wrap(
          ...
          children: <Widget>[
            _MicroProof(
              ...
              text: 'Professor e aluno conectados',
            ),
            _MicroProof(
              icon: Icons.lock_outline_rounded,
              text: 'Acesso autenticado',
            ),
          ],
        ),
      ],
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: LandingPage.line),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: LandingPage.surfaceRaised,
            ...
            child: const Row(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Text(
                    'Treino, feedback e evolução conectados no mesmo fluxo.',
                    style: TextStyle(
              ...
              return const Column(
                children: <Widget>[
                  _Benefit(
                    ...
                    title: 'Treinos',
                    text: 'Prescrição organizada e acessível no celular.',
                  ),
                  SizedBox(height: 10),
                  _Benefit(
                    icon: Icons.monitor_heart_rounded,
                    title: 'Acompanhamento',
                    text: 'Feedback e evolução no mesmo fluxo.',
                  ),
                  SizedBox(height: 10),
                  _Benefit(
                    icon: Icons.psychology_alt_rounded,
                    title: 'Decisão',
                    text: 'Sinais claros para o professor agir melhor.',
                  ),
                ],
              );
            }
...
class _ExperienceSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _Section(
      ...
      subtitle:
          'Cada perfil vê o que precisa, sem misturar operação profissional com execução do aluno.',
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
            ...
            return const Column(
              children: <Widget>[
                _RoleCard(
                  ...
                  text:
                      'Organize alunos, monte treinos, acompanhe feedbacks e identifique prioridades.',
                  bullets: <String>[
                    'Alunos e acessos',
                    'Planos de treino',
                    'Feedback e evolução',
                ...
                _RoleCard(
                  ...
                  title: 'Para o aluno',
                  text:
                      'Abra o treino no celular, registre a execução e mantenha o histórico conectado.',
                  bullets: <String>[
                    'Treino no celular',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            text,
            style: const TextStyle(color: LandingPage.muted, height: 1.5),
          ),
          const SizedBox(height: 18),
          ...bullets.map(
...
class _WorkflowSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _Section(
      ...
      subtitle:
          'Menos etapas soltas. Mais continuidade entre o que o professor prescreve e o que o aluno executa.',
      child: _WorkflowGrid(),
    );
  }
}
          ...
          return const Column(
            children: <Widget>[
              _Step(
                number: '01',
                title: 'Cadastre',
                text: 'Organize aluno e acesso em um único lugar.',
              ),
              SizedBox(height: 10),
              _Step(
                number: '02',
                title: 'Prescreva',
                text: 'Monte o treino e deixe a execução clara.',
              ),
              SizedBox(height: 10),
              _Step(
                number: '03',
                title: 'Acompanhe',
                text: 'Use feedback e evolução para decidir o próximo passo.',
              ),
            ],
          );
        }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            text,
            style: const TextStyle(color: LandingPage.muted, height: 1.45),
          ),
        ],
      ),
    );
    ...
    return _Shell(
      child: Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              colors: <Color>[Color(0xFF17140B), Color(0xFF101010)],
            ),
            borderRadius: BorderRadius.circular(24),
            ...
            builder: (BuildContext context, BoxConstraints constraints) {
              ...
              final Widget copy = const Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 8),
                  Text(
                    'Opções para personal individual, equipe e estúdio. No Android, assinaturas elegíveis são gerenciadas pelo Google Play.',
                    style: TextStyle(color: LandingPage.muted, height: 1.45),
                  ),
                ],
              );
              ...
              if (stack) {
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: <Widget>[copy, const SizedBox(height: 20), action],
                );
              }
              return Row(
                children: <Widget>[
...
class _Footer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      decoration: const BoxDecoration(
        border: Border(top: BorderSide(color: LandingPage.line)),
      ),
      child: _Shell(
        child: Padding(
          ...
          child: compact
              ? Column(
                  children: <Widget>[brand, const SizedBox(height: 8), links],
                )
              : Row(children: <Widget>[const Expanded(child: brand), links]),
        ),
      ),
    );
  }
